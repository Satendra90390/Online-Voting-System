...
root.iconbitmap(r"C:\Users\Lenovo\Pictures\Projects\projects\voting\favicon.ico")
root.configure(background="white")


homeImg = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\Pictures\Projects\projects\voting\homeImg.png")) 
...
def voterLogin():
    ...
    loginFrame.configure(background="navajo white")
...
def dashboard(voterId):
    ...
    label = Label(DashboardFrame, text="Your Vote, Your Voice", font=("Lucida Console", 30, "bold"), bg="white", fg=HIGHLIGHT_BG)
    label.place(x=175, y=50)

    nameLabel = Label(DashboardFrame, text="Hi "+name.get(), font=(ARIAL, 15, "normal"), bg="Khaki")
    ...
    pollInput = Combobox(root, values=["Vote for Change", "Future Leaders","Rise Together","The Winning Choice"], font=(ARIAL, 13, "normal"), textvariable=poll)
    pollInput.place(x=400, y=225, width=200)
    positionLabel = Label(DashboardFrame, text="Select your position", font=(ARIAL, 15, "normal"), bg="white")
    positionLabel.place(x=200, y=275)
    positionInput = Combobox(root, values=["President", "Vice President", "General Secretary", "Treasurer", "Cultural Secretary"], font=(ARIAL, 13, "normal"), textvariable=position)
    positionInput.place(x=400, y=275, width=200)
    
    def Vote():
        if poll.get()=="" or position.get()=="":
            messagebox.showwarning('Voting System Message','all field are required')

        else:
            result1 = model.findByVoterIdinVote(voterId)
            if(result1 == None):
                if model.submitVote(voterId, poll.get(), position.get()):
...
def voterRegistration():
    ...
    input4=Combobox(RegistrationFrame, values=["Male","Female","Others"], font=(ARIAL, 12, "normal"), textvariable=gender, background="#f0f0f0")
...
def AdminRegistration():
    ...
    genderInput=Combobox(root, values=["Male","Female","Others"], font=("", 12, "normal"), textvariable=gender)
...
def VoterHome():
    ...
    back_btn.place(x=0, y=0, width=100, height=50)
    label = Label(voterFrame, text="Your Vote,\nYour Voice", font=("Lucida Console", 30, "bold"), bg=HIGHLIGHT_BG, fg="white")
...
def AdminHome():
    ...
    back_btn.place(x=0, y=0, width=100, height=50)
    label = Label(adminFrame, text="Lorem Ipsum,\nLorem Ipsum", font=("Lucida Console", 30, "bold"), bg=HIGHLIGHT_BG, fg="white")
    label.place(x=500, y=0, width=400, height=500)
...
def Home():
    ...
    label = Label(homeFrame, text="Vote for the Future", font=("Lucida Console", 30, "bold"), bg="white", fg=HIGHLIGHT_TEXT)
    ...
    about = Label(homeFrame, text="💠", font=("Lucida Console", 18, "normal"), bg="white", fg="grey")
...
def AdminDashboard(regId):
    ...
    label = Label(admin, text=admin_name[2], font=("Lucida Console", 13, "normal"), bg=HIGHLIGHT_BG, fg="white")
...
def votingResults():
    ...
    total=Label(resultFrame,text="Total vote",font=("Lucida Console",15,"bold"),bg="white",fg=HIGHLIGHT_TEXT)
    total.place(x=150,y=50)
    party1=Label(resultFrame,text="Vote for Change",font=("Lucida Console",15,"normal"),bg="white",fg="grey")
    party1.place(x=150,y=150)
    party2=Label(resultFrame,text="Future Leaders",font=("Lucida Console",15,"normal"),bg="white",fg="grey")
    party2.place(x=150,y=200)
    party3=Label(resultFrame,text="Rise Together",font=("Lucida Console",15,"normal"),bg="white",fg="grey")
    party3.place(x=150,y=250)
    party4=Label(resultFrame,text="The Winning Choice",font=("Lucida Console",15,"normal"),bg="white",fg="grey")
...
def showAllRecord():
    ...
    name=Label(DataFrame,text="Name",font=("Lucida Console",13,"bold"),bg="white",fg=HIGHLIGHT_TEXT)
    name.place(x=20,y=20)
    phone=Label(DataFrame,text="Phone No.",font=("Lucida Console",13,"bold"),bg="white",fg=HIGHLIGHT_TEXT)
    phone.place(x=220,y=20)
    gender=Label(DataFrame,text="Gender",font=("Lucida Console",13,"bold"),bg="white",fg=HIGHLIGHT_TEXT)
    gender.place(x=365,y=20)
    address=Label(DataFrame,text="Locality",font=("Lucida Console",13,"bold"),bg="white",fg=HIGHLIGHT_TEXT)
